...
var Alaa = User(name: "Alaa", age: 23, height: 162, weight: 52, activityLevel: 8)

print("\(Alaa.name) is \(Alaa.age) years old. He is \(Alaa.height)cm tall and weighs \(Alaa.weight)kg. His activity level is \(Alaa.activityLevel).")
